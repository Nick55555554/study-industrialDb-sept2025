...
class DDoSAttackApp:
    def __init__(self):
        ...
        self.file_handler = FileHandler("ddos_attacks_advanced.json")
        self.attacks = self.file_handler.load_data()
    ...
    def create_layout(self, parent):
        ...
        # Показываем форму по умолчанию
        self.show_attack_form()
    ...
    def save_data(self):
        """Сохранение данных"""
        self.file_handler.save_data(self.attacks)
